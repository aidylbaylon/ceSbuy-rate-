...
if (empty($_POST) === false) {
	...
	if (empty($username) === true || empty($password) === true) {
		$errors[] = '<div class="alert alert-danger">
                    <a href="#" class="alert-link">Sorry, but we need your username and password.</a>
                 </div>';
	} else if ($users->user_exists($username) === false) {
		$errors[] = '<div class="alert alert-danger">
                    <a href="#" class="alert-link">Sorry that username doesn\'t exists.</a>
                 </div>';
		...
		if (strlen($password) > 18) {
			$errors[] = '<div class="alert alert-danger">
                    <a href="#" class="alert-link">The password should be less than 18 characters, without spacing.</a>
                 </div>';
		}
		$login = $users->login($username, $password);
		if ($login === false) {
		$errors[] = '<div class="alert alert-danger">
                    <a href="#" class="alert-link">Sorry, that username/password is invalid</a>
                 </div>';
		}else {
